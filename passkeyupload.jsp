...
<section class="wrapper">
    ...
    <form id="registerform" method="get" name="registerform" action="<%=request.getContextPath()%>/DownloadFile" >
     ...
     <div class="row sub_content">
           ...
           <div class="project_details">
							<div class="widget_title">
								<h4><span>Enter PassKey of the  File to Download</span></h4>
							</div>
							<ul class="details">
								
								<li><span>Enter Passkey: </span>  <input type="password" class="form-control" name="passkey"></li>
								
								
							</ul>
						</div>
						 <button type="submit" name="submit" value="submitpasskey" class="btn btn-default btn-lg button">Submit</button>
