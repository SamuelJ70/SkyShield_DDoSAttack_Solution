...
/* 	ResultSet rs=(ResultSet)request.getAttribute("rs"); */
	...
	int id=0;
	String userid="",name="",add="",email="",phone="",city="",gender="",uid="";
	if(no==0)
		
		
 uid=(String)session.getAttribute("uid").toString();
     ...
     <div class="row sub_content">
           ...
           <div class="project_details">
							...
							<ul class="details">
								...
								<li><span>User Id: </span>  <input type="text" class="form-control" name="uid" value="<%=uid%>" readonly="readonly"	></li>
							...
							<%-- 	<li><span>Gender :</span><input type="text" class="form-control" name="gender" value="<%=gender%>" 	></li> --%>
								<li><span>Mail Id:</span><input type="text" class="form-control" name="email" value="<%=email%>" readonly="readonly"> </li>
