...
body{
background-image:url('images/user-module.jpg');
...
String ipp=thisIp.getHostAddress();
session.setAttribute("ipp",ipp);
        ...
        <div id="logo-bar">
            <div class="container">
                <div class="row">
                    ...
                    <div  class="col-lg-3 col-sm-3 " style="position:absolute; top: 1px;height:100px;">
                        <div id="logo">
