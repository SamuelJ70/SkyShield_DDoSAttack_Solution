...
<section class="wrapper">
    ...
    <form id="registerform" method="post" name="registerform" action="<%=request.getContextPath()%>/UploadToServer" enctype="multipart/form-data">
     ...
     <div class="row sub_content">
           ...
           <div class="project_details">
							<div class="widget_title">
								<h4><span>Upload File</span></h4>
							</div>
							<ul class="details">
								
								<li><span>Choose File: </span>  <input type="file" class="form-control" name="file" 	></li>
								
								
							</ul>
						</div>
						 <button type="submit" name="submit" value="changepass" class="btn btn-default btn-lg button">Upload</button>
